...
/** HP-badge over grotte-goblin (samme skaleringslogik som crystal beast, lidt lavere end 5.55). */
export function grotteGoblinHpLabelLocalY(bulk: number): number {
  return bulk * SEAM_SKULKER_SCALE_MUL * 5.2
}
...
const GLB_URL = '/assets/mobs/grotte_goblin.glb'

export default function GrotteGoblinSkulkerMob({
  bulk,
  visualSeed,
  slotWorldX,
  slotWorldZ,
